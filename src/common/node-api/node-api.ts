...
export class NodeApi {
    ...
    async addUser(user: AddUserContract.Request): Promise<AddUserContract.Response> {
        const response = await this.nodeAxios.request({
            method: 'POST',
            url: AddUserContract.url,
            data: user,
            timeout: 20000,
        });
    ...
    async removeUser(user: RemoveUserContract.Request): Promise<RemoveUserContract.Response> {
        const response = await this.nodeAxios.request({
            method: 'POST',
            url: RemoveUserContract.url,
            data: user,
            timeout: 20000,
        });
